...
// ExchangeRate SDK utility: graphql
//
...
class ExchangeRateGraphql
{
    ...
    // equivalent.
    public static function body(ExchangeRateContext $ctx): mixed
    {
    ...
    public static function errors(ExchangeRateContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
