...
// ExchangeRate SDK utility: make_options

class ExchangeRateMakeOptions
{
    ...
    public static function call(ExchangeRateContext $ctx): array
    {
        ...
        //
        // `ExchangeRateSchema::optspec()` is built from the model:
        ...
        $optspec = ExchangeRateSchema::optspec();
