...
// ExchangeRate SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ExchangeRateTransformResponse
{
    public static function call(ExchangeRateContext $ctx): mixed
    {
        ...
        $transform = ExchangeRateHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
