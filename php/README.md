...
The PHP SDK for the ExchangeRate API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Latest(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->ExchangeRate(null)->load(
    ["id" => "test01"], null
);
