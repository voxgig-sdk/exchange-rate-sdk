...
// ExchangeRate SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ExchangeRateOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ExchangeRateOmni::structfix($now, Struct::undef()))
                        !== json_encode(ExchangeRateOmni::structfix($val, Struct::undef()))) {
