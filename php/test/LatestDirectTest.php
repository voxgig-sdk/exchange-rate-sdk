...
class LatestDirectTest extends TestCase
{
    public function test_direct_load_latest(): void
    {
        $setup = latest_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-latest", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
