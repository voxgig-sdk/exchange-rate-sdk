...
// ExchangeRate SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ExchangeRateSDK::test)
...
{
    private const SDK_CLASS = 'ExchangeRateSDK';
    ...
    private const SDK_BASE = 'exchangerate_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../exchangerate_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
