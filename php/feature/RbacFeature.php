...
class ExchangeRateRbacFeature extends ExchangeRateBaseFeature
{
    ...
    private function _required(ExchangeRateContext $ctx): ?string
    {
    ...
    private function _reject(ExchangeRateContext $ctx, string $required): void
    {
    ...
    private function _track(ExchangeRateContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
