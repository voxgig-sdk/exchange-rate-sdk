...
// ExchangeRate SDK streaming feature
...
class ExchangeRateStreamingFeature extends ExchangeRateBaseFeature
{
    ...
    private function _iterate(ExchangeRateResult $result): \Generator
    {
    ...
    private function _streamable(ExchangeRateContext $ctx): bool
    {
