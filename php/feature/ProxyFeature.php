...
// ExchangeRate SDK proxy feature
...
class ExchangeRateProxyFeature extends ExchangeRateBaseFeature
{
    ...
    public function init(ExchangeRateContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ExchangeRateContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
