...
// ExchangeRate SDK cache feature
...
class ExchangeRateCacheFeature extends ExchangeRateBaseFeature
{
    ...
    private function _through(ExchangeRateContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
