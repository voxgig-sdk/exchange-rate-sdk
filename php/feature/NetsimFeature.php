...
// ExchangeRate SDK netsim feature
...
class ExchangeRateNetsimFeature extends ExchangeRateBaseFeature
{
    ...
    private function _simulate(ExchangeRateContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ExchangeRateContext $ctx, array $applied): void
    {
        $client = $this->client;
