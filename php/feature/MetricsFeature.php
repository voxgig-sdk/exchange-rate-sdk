...
// ExchangeRate SDK metrics feature
...
class ExchangeRateMetricsFeature extends ExchangeRateBaseFeature
{
    ...
    private function _record(ExchangeRateContext $ctx, bool $ok): void
    {
