...
// ExchangeRate SDK audit feature
...
class ExchangeRateAuditFeature extends ExchangeRateBaseFeature
{
    ...
    private function _emit(ExchangeRateContext $ctx, string $outcome): void
    {
