...
// ExchangeRate SDK debug feature
...
class ExchangeRateDebugFeature extends ExchangeRateBaseFeature
{
    ...
    private function _finish(ExchangeRateContext $ctx, bool $ok): void
    {
