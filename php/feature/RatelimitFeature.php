...
// ExchangeRate SDK ratelimit feature
...
class ExchangeRateRatelimitFeature extends ExchangeRateBaseFeature
{
    ...
    private function _acquire(ExchangeRateContext $ctx): void
    {
    ...
    private function _track(ExchangeRateContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
