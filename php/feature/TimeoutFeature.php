...
// ExchangeRate SDK timeout feature
...
class ExchangeRateTimeoutFeature extends ExchangeRateBaseFeature
{
    ...
    private function _with_timeout(ExchangeRateContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ExchangeRateContext $_ctx, float $ms): void
    {
        $client = $this->client;
