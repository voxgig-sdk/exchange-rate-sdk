// Command ExchangeRate-mcp is an MCP server exposing the ExchangeRate
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ExchangeRate_list  — list records of an entity
//	ExchangeRate_load  — load a single record of an entity
//
