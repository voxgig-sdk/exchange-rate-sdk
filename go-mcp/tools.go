...
type Args struct {
	Entity string         `json:"entity" jsonschema:"latest"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ExchangeRateSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "exchange-rate_list",
		Description: "List records from ExchangeRate. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "exchange-rate_load",
		Description: "Load a single record from ExchangeRate. " +
...
func runOp(client *sdk.ExchangeRateSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ExchangeRateSDK, name string) (sdk.ExchangeRateEntity, error) {
