...
class ExchangeRateTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ExchangeRateTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ExchangeRateTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ExchangeRateTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
