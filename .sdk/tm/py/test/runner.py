...
class ExchangeRateTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ExchangeRateTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ExchangeRateTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ExchangeRateTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
