...
from projectname_sdk.core.control import ExchangeRateControl
...
class ExchangeRateContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ExchangeRateSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ExchangeRateResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ExchangeRateResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ExchangeRateError(code, msg, self)
