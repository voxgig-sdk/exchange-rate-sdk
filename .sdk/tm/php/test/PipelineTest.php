...
// ExchangeRate SDK pipeline test
//
...
{
    private static function utility(): ExchangeRateUtility
    {
        return new ExchangeRateUtility();
    }
    ...
    private static function ctx(array $over = []): ExchangeRateContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ExchangeRateContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ExchangeRateOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ExchangeRateError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ExchangeRateOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ExchangeRateMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ExchangeRateOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ExchangeRateMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ExchangeRateOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ExchangeRateMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ExchangeRateSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ExchangeRateMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            ...
            'result' => new ExchangeRateResult([]),
        ]);
        [, $err] = ExchangeRateMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ExchangeRateSpec([]),
            'response' => null,
            'result' => new ExchangeRateResult([]),
        ]);
        [, $err] = ExchangeRateMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ExchangeRateSpec(['step' => 's']),
            'response' => new ExchangeRateResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ExchangeRateResult([]),
        ]);
        [, $err] = ExchangeRateMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ExchangeRateSpec(['step' => 's']),
            'response' => new ExchangeRateResponse(self::resp(200, ['v' => 1])),
            'result' => new ExchangeRateResult([]),
        ]);
        [, $err] = ExchangeRateMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ExchangeRateSpec(['step' => 's']),
            'response' => new ExchangeRateResponse(self::resp(200, ['v' => 2])),
            'result' => new ExchangeRateResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ExchangeRateMakeResponse::call($ctx);
    ...
    {
        $preset = new ExchangeRateResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ExchangeRateSpec([]),
            'response' => new ExchangeRateResponse([]),
            'result' => new ExchangeRateResult([]),
        ...
        [$got, $err] = ExchangeRateMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ExchangeRateResult([])]);
        [, $err] = ExchangeRateMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ExchangeRateSpec([]), 'result' => null]);
        [, $err] = ExchangeRateMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ExchangeRateSpec(['step' => 's']),
            'result' => new ExchangeRateResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ExchangeRateOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ExchangeRateMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ExchangeRateSpec(['step' => 's']),
            'result' => new ExchangeRateResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ExchangeRateOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ExchangeRateMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ExchangeRateResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ExchangeRateSpec([]),
            'result' => new ExchangeRateResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ExchangeRateMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ExchangeRateMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ExchangeRateError('boom', 'boom');
        $utility->fetcher = function (ExchangeRateContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ExchangeRateSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ExchangeRateMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ExchangeRateContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ExchangeRateMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ExchangeRateContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ExchangeRateSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ExchangeRateMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ExchangeRateResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ExchangeRateSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ExchangeRateMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ExchangeRateMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ExchangeRateMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ExchangeRateResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ExchangeRateDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ExchangeRateResult(['ok' => false])]);
        $this->expectException(ExchangeRateError::class);
        ExchangeRateDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ExchangeRateResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ExchangeRateMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ExchangeRateMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ExchangeRateBaseFeature();
        $b = new ExchangeRateBaseFeature();
        ExchangeRateFeatureAdd::call($ctx, $a);
        ExchangeRateFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ExchangeRateBaseFeature
    {
        $f = new ExchangeRateBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ExchangeRateFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ExchangeRateContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ExchangeRateSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ExchangeRatePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ExchangeRatePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ExchangeRateResponse(['headers' => null]),
            'result' => new ExchangeRateResult([]),
        ]);
        ExchangeRateResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ExchangeRateResultBody::call($ctx);
