...
// ExchangeRate SDK idempotency feature
...
class ExchangeRateIdempotencyFeature extends ExchangeRateBaseFeature
{
    ...
    private function _mutating(ExchangeRateContext $ctx): bool
    {
