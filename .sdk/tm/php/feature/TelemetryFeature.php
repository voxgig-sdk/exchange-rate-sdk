...
// ExchangeRate SDK telemetry feature
...
class ExchangeRateTelemetryFeature extends ExchangeRateBaseFeature
{
    ...
    private function _close(ExchangeRateContext $ctx, bool $ok): void
    {
