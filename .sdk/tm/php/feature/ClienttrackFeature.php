...
// ExchangeRate SDK clienttrack feature
...
class ExchangeRateClienttrackFeature extends ExchangeRateBaseFeature
{
    ...
    public function PostConstruct(ExchangeRateContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ExchangeRate-SDK';
