...
// ExchangeRate SDK utility: fetcher
...
class ExchangeRateFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ExchangeRateSDK/1.0)';
    ...
    public static function call(ExchangeRateContext $ctx, string $fullurl, array $fetchdef): array
    {
