...
|---|---|---|
| `ts/` | @voxgig-sdk/exchange-rate-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/exchange-rate-sdk \
      --repository voxgig-sdk/exchange-rate-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/exchange-rate-sdk` shows it, and
`npm trust revoke @voxgig-sdk/exchange-rate-sdk --id=<id>` removes it.
