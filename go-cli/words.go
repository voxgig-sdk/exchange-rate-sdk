...
func registerSDKWords(r *eng.Registry, client *sdk.ExchangeRateSDK) {
...
func runOp(client *sdk.ExchangeRateSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
