...
AQL-driven CLI and REPL for the ExchangeRate SDK. Positional arguments are
...
./exchange-rate-cli list latest
./exchange-rate-cli load 1 latest
./exchange-rate-cli load '{id:1}' latest
