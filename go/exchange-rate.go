...
// instead of `sdk.NewExchangeRateSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ExchangeRateSDK  { return NewExchangeRateSDK(nil) }
func Test() *ExchangeRateSDK { return TestSDK(nil, nil) }
