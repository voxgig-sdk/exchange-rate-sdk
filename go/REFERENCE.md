# ExchangeRate Golang SDK Reference

Complete API reference for the ExchangeRate Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *ExchangeRateSDK`
...
#### `Latest(data map[string]any) ExchangeRateEntity`
