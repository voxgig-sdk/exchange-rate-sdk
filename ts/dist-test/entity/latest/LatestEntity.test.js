...
(0, node_test_1.describe)('LatestEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.ExchangeRateSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'latest.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let client = __1.ExchangeRateSDK.test(options, extra);
    ...
    if (live) {
        client = new __1.ExchangeRateSDK(merge([
