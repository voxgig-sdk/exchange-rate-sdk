# ExchangeRate SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ExchangeRateSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ExchangeRateSDK(...) and ExchangeRateSDK.test(...) become
#      ExchangeRateSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "exchangerate_sdk"
_SDK_CLASS = "ExchangeRateSDK"
