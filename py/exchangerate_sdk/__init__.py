...
from exchangerate_sdk.utility import register

# Load features
from exchangerate_sdk.feature.base_feature import ExchangeRateBaseFeature
from exchangerate_sdk.features import _has_feature, _make_feature
...
class ExchangeRateSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ExchangeRateUtility()
        self._utility = utility

        from exchangerate_sdk.config import shared_config
    ...
    def get_utility(self):
        return ExchangeRateUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ExchangeRateSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Latest(self, data=None) -> "LatestEntity":
        ...
        from exchangerate_sdk.entity.latest_entity import LatestEntity
