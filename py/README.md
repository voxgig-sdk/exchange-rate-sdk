# ExchangeRate Python SDK



The Python SDK for the ExchangeRate API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Latest()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/exchange-rate-sdk/releases)) or
...
```
py/
├── exchangerate_sdk.py         -- Main SDK module
