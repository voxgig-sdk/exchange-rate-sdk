...
require_relative 'ExchangeRate_types'
...
class ExchangeRateSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = ExchangeRateHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = ExchangeRateHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, ExchangeRateFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    ExchangeRateUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = ExchangeRateHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = ExchangeRateHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = ExchangeRateHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = ExchangeRateHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = ExchangeRateError.new(
        "graphql_error", "ExchangeRateSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = ExchangeRateSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
