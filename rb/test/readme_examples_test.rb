...
#      offline in seeded test mode (ExchangeRateSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ExchangeRate_sdk.rb")
  SDK_CLASS = "ExchangeRateSDK"
