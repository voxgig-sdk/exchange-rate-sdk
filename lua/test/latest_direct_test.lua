...
describe("LatestDirect", function()
  it("should direct-load-latest", function()
    local setup = latest_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-latest", setup.live and "live" or "unit")
...
function latest_direct_setup(mockres)
