...
function runner.env_override(m)
  local live = runner.getenv("EXCHANGERATE_TEST_LIVE")
  local override = runner.getenv("EXCHANGERATE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("EXCHANGERATE_TEST_EXPLAIN")
