...
function runner.env_override(m)
  local live = runner.getenv("EXCHANGE_RATE_TEST_LIVE")
  local override = runner.getenv("EXCHANGE_RATE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("EXCHANGE_RATE_TEST_EXPLAIN")
